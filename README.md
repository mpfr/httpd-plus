...
Send notification messages to UNIX-domain sockets for `server` and/or `location` sections with a `block` option in [`httpd.conf(5)`](https://mpfr.net/man/httpd-plus/6.7-stable/httpd.conf.5.html#message).
