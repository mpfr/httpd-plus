...
* [Commits](https://github.com/openbsd/src/commits/master/usr.sbin/httpd) to `-current` backported to `6.7-stable` until December 31, 2020 except:
...
httpd-plus-6.7-stable/03-client-ip-filters.patch
